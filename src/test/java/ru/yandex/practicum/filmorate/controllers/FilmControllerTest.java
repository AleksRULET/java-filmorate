...
class FilmControllerTest {
    ...
    void getAll() {
        ...
        Assertions.assertEquals(films.toArray()[1].toString(), "Film(id=2, name=Film2, releaseDate=2000-01-01, description=Desc, duration=91, rate=5)");
    }
    ...
    void update() {
        ...
        assertEquals("Такого фильма не существует", exception.getMessage(), "Ошибка в выбрасывании исключения");
        film3.setId(1);
