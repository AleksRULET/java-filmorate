...
class UserControllerTest {
    ...
    void getAll() {
        ...
        userController.create(new User("login", "User1",0, "email@yandex.ru", LocalDate.of(2000,12,12), Set.of(1)));
        userController.create(new User("login", "User2", 0, "email@yandex.ru", LocalDate.of(2000,12,12), Set.of(1)));
    ...
    @Test
    void create() {
        User user1 = new User("login", "User1", 0, "email@yandex.ru", LocalDate.of(2000,12,12), Set.of(1));
        ...
        User user2 = new User("user2", null, 0, "email@yandex.ru", LocalDate.of(2000,12,12), Set.of(1));
    ...
    @Test
    void update() {
        User user1 = new User("login", "User1", 1,"email@yandex.ru", LocalDate.of(2000,12,12), Set.of(1));
        userController.create(user1);
        User user2 = new User("login", "User2", 1, "email@yandex.ru", LocalDate.of(2000,12,12), Set.of(1));
        ...
        User user3 = new User("login 3", "User3", 0, "email@yandex.ru", LocalDate.of(2000,12,12), Set.of(1));
        RuntimeException exception = assertThrows(
                RuntimeException.class,
        ...
        User user4 = new User("user4", null, 1, "email@yandex.ru", LocalDate.of(2000,12,12), Set.of(1));
